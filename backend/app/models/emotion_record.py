...
class EmotionRecord(db.Model):
    ...
    emotion_id = db.Column(db.BigInteger, primary_key=True, autoincrement=True)
    ...
    attendance_record_id = db.Column(db.BigInteger, db.ForeignKey('attendance_record.record_id', ondelete='CASCADE'), nullable=True)
    group_detail_id = db.Column(db.BigInteger, db.ForeignKey('group_photo_recognition_detail.detail_id', ondelete='CASCADE'), nullable=True)
